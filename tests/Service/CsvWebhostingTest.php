...
class IpLocation_Service_CsvWebhostingTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $service = new IpLocation_Service_CsvWebhosting();
        $this->assertTrue($service->updateData());
    }

    public function testIpLocationBbc()
    {
        $objIpLocationObject = new IpLocation_Service_CsvWebhosting();
