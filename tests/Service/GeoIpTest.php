...
class IpLocation_Service_GeoIpTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $service = new IpLocation_Service_GeoIp();
        $this->assertTrue($service->updateData());
    }

    public function testIpLocationBbc()
    {
        $objIpLocationObject = new IpLocation_Service_GeoIp();
    ...
    public function testIpLocationNotAnIp()
    {
        $objIpLocationObject = new IpLocation_Service_GeoIp();
        $results = $objIpLocationObject->getIpLocation('10101010');
        $this->assertFalse($results);
    }    
}